...
%% CREACIÓN DEL TEXTO QUE SE MUESTRA POR PANTALLA.
 string=sprintf(['Bienvenido a CalculoPlacasMEF!\n\nEste programa calcula desplazamientos, giros y tensiones elásticas en placas poligonales. Se usa la teoría de placas gruesas de Reissner-Mindlin y el elemento finito triangular DKT.'...
       ...
       '\n3. Carga Puntual: aplica una carga puntual sobre un nodo \n4. Línea de Área de Carga: línea entre dos nodos, que forma parte de un área de carga repartida'...
       ...
       'El panel de botones laterales "introducir cálculos" introduce los parámetros gráficos en el programa y es necesario para el desarrollo del mismo. Se recomienda introducir los parámetros'...
       ...
       '\n\nPara calcular los desplazamientos es necesario introducir también las condiciones de contorno. Para introducir condiciones de contorno se puede seleccionar un área o modificar la condición'...
       'de un nodo existente. \n\nUna vez calculados los desplazamientos, Se pueden observar los resultados deseados mediante los botones del panel mostrar, ya sea sobre el plano o sobre el gráfico 3D'...
       '\n\nPor favor, enviar cualquier error o sugerencia a: j.morato.91@gmail.com']);
